...
It is based on the standalone Go library <https://github.com/TeknooSoftware/supercronic/cronexpr>.

## Install

    go get github.com/TeknooSoftware/supercronic/cronexpr
    go install github.com/TeknooSoftware/supercronic/cronexpr
